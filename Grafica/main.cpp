...
int main() {
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        // Soarele 
        glm::vec3 sunPos = cameraPos + glm::vec3(0.0f, 50.0f, 0.0f);
        glm::mat4 sunProj = glm::ortho(-150.0f, 150.0f, -150.0f, 150.0f, 1.0f, 150.0f);
        glm::mat4 sunView = glm::lookAt(sunPos, sunPos + lightDirSun, glm::vec3(0.0f, 1.0f, 0.0f));
        lightSpaceMatrices[0] = sunProj * sunView;

        // Stalpii
        for (int i = 0; i < 2; i++) {
            glm::mat4 spotProj = glm::perspective(glm::radians(90.0f), 1.0f, 1.0f, 100.0f);
            glm::mat4 spotView = glm::lookAt(spotLightPositions[i], spotLightPositions[i] + glm::vec3(0.0f, -1.0f, 0.0f), glm::vec3(0.0f, 0.0f, -1.0f));
        ...
        // PREGATIM SHADERUL CU CELE 3 LUMINI
        floorShader.use();
        ...
        // ACTIVAM CELE 3 TEXTURI DE UMBRE
        ...
        glActiveTexture(GL_TEXTURE0); // Slotul 0 ramane pentru vopsea/textura

        // DESENAM OBIECTELE FIZICE 
